# Starter — YC Voice Agents Hackathon

> The original Pipecat starter README, preserved here for setup, deployment, and Twilio wiring. The repo root README is the hackathon submission for **Confucius**.
